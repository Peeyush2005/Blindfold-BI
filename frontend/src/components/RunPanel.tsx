    ...
    >
      ...
      <div className="flex items-center justify-between px-3.5 py-2.5 bg-slate-900/90 border-b border-slate-800/80">
        <div className="flex items-center space-x-3 flex-wrap gap-y-1">
          ...
          {/* Narration Source Badge (Step 0) */}
          {narrationSource === 'llm' && (
            <span
              className="px-1.5 py-0.5 rounded text-[10px] font-mono font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
              title="Narration generated by LLM and verified against facts"
            >
              LLM
            </span>
          )}
          {narrationSource === 'llm_repaired' && (
            <span
              className="px-1.5 py-0.5 rounded text-[10px] font-mono font-semibold bg-amber-500/10 text-amber-400 border border-amber-500/20"
          ...
          {narrationSource === 'template' && (
            <span
              className="px-1.5 py-0.5 rounded text-[10px] font-mono font-semibold bg-sky-500/10 text-sky-400 border border-sky-500/20"
              title={`Dynamic deterministic template: ${templateReason || 'fallback'}`}
            >
              TEMPLATE{templateReason ? ` (${templateReason})` : ''}
            </span>
          )}
          ...
          {model && (
            <span
              className="text-[10px] font-mono text-slate-400 truncate max-w-[120px] sm:max-w-[160px]"
              title={`Model: ${model}`}
            >
